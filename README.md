...
| CVE-2023-33829 | SCM Manager XSS漏洞                                     | 已有     |
| CVE-2024-10924 | WordPress Really Simple Security插件任意用户登陆漏洞    | 已有     |
| CVE-2024-22120 | Zabbix zbx_auditlog_global_script远程命令执行漏洞       | 已有     |
